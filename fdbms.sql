    ...
    INSERT INTO `FDMS_dev`.`users` (`user_id`, `user_name`, `user_pass`, `isAdmin`) VALUES 
    ('userid1', 'Arunoday kumar', 'pass1', '0'),
    ('userid2', 'Kapil kumar', 'pass2', '0'),
    ('userid3', 'Ashish Singh', 'pass3', '1'),
    ('userid4', 'Shivam Malpaani', 'pass4', '1');
    
    INSERT INTO `FDMS_dev`.`users_details` (`user_id`, `user_email`, `user_phno`, `user_addline`, `user_pincode`, `user_joindt`) VALUES 
    ...
    INSERT INTO `FDMS_dev`.`restaurant` (`rest_id`,`rest_email`, `rest_phno`, `rest_addline`, `rest_pincode`, `rest_joindt`, `rest_owner_id`) VALUES
    ...
    INSERT INTO `FDMS_dev`.`dishes` (`dish_name`, `dish_price`, `isAvailable`, `dish_type`, `dish_rest_id`) VALUES
    ('Aloo paratha', '40', '1', 'main course', 'restid1'),
    ('Gulab Jamun', '60', '1', 'dessert', 'restid2'),
    ('Coca Cola', '20', '1', 'beverage', 'restid2');
    ...
    -- UPDATE dishes SET dish_name = "French Fries", dish_price = 45, isAvailable= 1, dish_type= "starter", dish_rest_id = "restid1" WHERE dish_id = 7;
